...
public class Const {
	...
	public static int PWD_SAFETY_FACTOR_OK = 3;
	public static int PWD_SAFETY_FACTOR_BAD = 4;
	public static int LOGIN_MODE_CLEAR = 1;
	public static int LOGIN_MODE_GRABLED = 2;
